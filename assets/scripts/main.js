...
async function getRecipes() {
  ...
  return new Promise(async (resolve, reject) => {  // Corrected the syntax here
    ...
    for (let url of RECIPE_URLS) {
      ...
      try {
        ...
        //            we have provided. Then, pass the recipes family to the Promise's
        //            resolve() method.
        ...
        reject(err);
        return; // Exiting function after rejection
      }
    }
  });
}
